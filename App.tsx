...
const s = StyleSheet.create({
  ...
  inputShell: { height: 57, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#285c47", backgroundColor: "rgba(7,24,18,.96)", borderRadius: 13, paddingHorizontal: 14, shadowColor: "#53f6a7", shadowOpacity: .10, shadowRadius: 8 },
